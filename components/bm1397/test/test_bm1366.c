...
TEST_CASE("Testing single BM1366 chip against a known valid block", "[bm1366]")
{
    ...
    */
    ...
    notify_message.difficulty = 1024; // can be as high as 652198270
    ...
    for (uint16_t i = 0; i < 256; i=i+64) {
        ...
        int counter = 1;
        while (asic_result != NULL && counter <= 60) {
