...
static uint8_t _send_init(uint64_t frequency)
{
    ...
    //Reg 0x10 used to be set to {0x55, 0xAA, 0x51, 0x09, 0x00, 0x10, 0x00, 0x00, 0x15, 0x1C, 0x02}
    uint32_t full_nonce_scope = 0x151c * 128;
    BM1366_set_nonce_scope(full_nonce_scope / chip_counter);
