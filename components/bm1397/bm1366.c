...
static uint8_t _send_init(uint64_t frequency, uint16_t asic_count)
{
    ...
    unsigned char set_10_hash_counting[6] = {0x00, 0x10, 0x00, 0x0A, 0xFF, 0x00}; //supposedly the "full" 32bit nonce range
    _send_BM1366((TYPE_CMD | GROUP_ALL | CMD_WRITE), set_10_hash_counting, 6, true);
